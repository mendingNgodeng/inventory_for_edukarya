    ...
    <tr>
      <td colSpan={3} className="px-6 py-10 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 font-medium">Tidak ada lokasi</p>
              ...
              {pageData.length > 0 ? (
                pageData.map((loc) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right flex justify-center gap-1 text-sm font-medium">
                      <Button
                        variant="primary"
                        onClick={() => onEdit(loc)}
                        className="mr-2"
                      ...
                      <Button
                        variant="danger"
                        onClick={() => onDelete(loc.id_location)}
                      >
