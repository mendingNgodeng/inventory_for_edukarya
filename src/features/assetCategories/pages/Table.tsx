...
const Table: React.FC<CtgTableProps> = ({
  data,
  onEdit,
  onDelete,
}) => {
    ...
    <tr>
      <td colSpan={3} className="px-6 py-10 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 font-medium">Tidak ada Kategori</p>
              ...
              {data.length > 0 ? (
                data.map((loc) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex justify-center gap-1 text-right text-sm font-medium">
                      <Button
                        variant="primary"
                        onClick={() => onEdit(loc)}
                        className="mr-2"
                      ...
                      <Button
                        variant="danger"
                        onClick={() => onDelete(loc.id_asset_categories)}
                      >
