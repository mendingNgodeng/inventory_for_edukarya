...
import { useData } from '../../../api/assetCategories/hooks';
import type { Data, CtgFormData } from './Types';
...
const [deleteLoading, setDeleteLoading] = useState(false);
  ...
  try {
    ...
    toast.error("Gagal menghapus Kataegori. data ini masih digunakan oleh tabel lain!");
  } finally {
