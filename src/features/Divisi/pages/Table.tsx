...
import type { TypesTableProps } from "./Types";
import Button from "../../../components/ui/button";
import Pagination from "../../../components/ui/pagination";
import { Pencil, TrashIcon } from "lucide-react";

const Table: React.FC<TypesTableProps> = ({ data, onEdit, onDelete }) => {
  // pagination state
    ...
    <tr>
      <td colSpan={3} className="px-6 py-10 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 font-medium">Tidak ada Tipe Aset</p>
          <p className="text-gray-400 text-sm mt-1">Data Tipe Aset belum tersedia</p>
        </div>
      </td>
    </tr>
  );
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-gray-800">Daftar Tipe Aset</h2>
          </div>
        ...
        <div className="h-full overflow-auto">
          <table className="w-full divide-y divide-gray-200 min-w-[600px] table-fixed">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {pageData.length > 0 ? (
                pageData.map((loc) => (
                  <tr key={loc.id_divisi} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center flex gap-2 text-sm font-medium">
                      ...
                      <Button variant="danger" onClick={() => onDelete(loc.id_divisi)}>
