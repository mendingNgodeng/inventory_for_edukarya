...
import { useData } from '../../../api/divisi/hooks';
...
const [deleteLoading, setDeleteLoading] = useState(false);
  ...
  try {
    ...
    toast.error("Gagal menghapus Divisi. data ini masih digunakan oleh tabel lain!");
  } finally {
...
const handleSubmit = async (data: TypesFormData) => {
  if (editingData) {
    await updateData(editingData.id_divisi, data);
